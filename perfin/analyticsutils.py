...
def getsavings(data, column_debit='Debit', column_credit='Credit', dt_start=None, dt_end=None, aggregation_period='M', thresh=1):
    ...
    aggregated = data[dt_start:dt_end][[column_debit, column_credit]].groupby(pd.TimeGrouper(aggregation_period)).sum()
